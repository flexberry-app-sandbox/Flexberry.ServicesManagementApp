...
moduleForModel('i-i-s-services-management-app-customer-request', 'Unit | Serializer | i-i-s-services-management-app-customer-request', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-app-customer-request',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
