...
moduleForModel('i-i-s-services-management-app-ticket', 'Unit | Serializer | i-i-s-services-management-app-ticket', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-app-ticket',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
