...
moduleForModel('i-i-s-services-management-app-customer', 'Unit | Serializer | i-i-s-services-management-app-customer', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-app-customer',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
