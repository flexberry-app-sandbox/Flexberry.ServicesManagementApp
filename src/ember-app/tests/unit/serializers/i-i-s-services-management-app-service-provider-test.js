...
moduleForModel('i-i-s-services-management-app-service-provider', 'Unit | Serializer | i-i-s-services-management-app-service-provider', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-app-service-provider',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
