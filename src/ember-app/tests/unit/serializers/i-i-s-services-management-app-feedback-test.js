...
moduleForModel('i-i-s-services-management-app-feedback', 'Unit | Serializer | i-i-s-services-management-app-feedback', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-services-management-app-feedback',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
