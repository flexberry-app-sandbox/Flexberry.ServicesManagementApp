...
moduleForAcceptance('[AGAT] Acceptance | i i s services management app service provider l');

test('testing i-i-s-services-management-app-service-provider-l', function(assert) {
