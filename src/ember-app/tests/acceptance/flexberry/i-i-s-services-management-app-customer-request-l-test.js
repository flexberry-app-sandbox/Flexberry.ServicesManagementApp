...
moduleForAcceptance('[AGAT] Acceptance | i i s services management app customer request l');

test('testing i-i-s-services-management-app-customer-request-l', function(assert) {
